...
class BluetoothApp3 extends StatefulWidget {
  static const routebluetooth3 = '/bluetooth3-page';

  @override
  _BluetoothApp3State createState() => _BluetoothApp3State();
}

class _BluetoothApp3State extends State<BluetoothApp3> {
