...
class BluetoothApp6 extends StatefulWidget {
  static const routebluetooth6 = '/bluetooth6-page';

  @override
  _BluetoothApp6State createState() => _BluetoothApp6State();
}

class _BluetoothApp6State extends State<BluetoothApp6> {
