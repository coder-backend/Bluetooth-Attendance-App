...
class BluetoothApp4 extends StatefulWidget {
  static const routebluetooth4 = '/bluetooth4-page';

  @override
  _BluetoothApp4State createState() => _BluetoothApp4State();
}

class _BluetoothApp4State extends State<BluetoothApp4> {
