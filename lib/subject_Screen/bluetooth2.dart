...
class BluetoothApp2 extends StatefulWidget {
  static const routebluetooth2 = '/bluetooth2-page';

  @override
  _BluetoothApp2State createState() => _BluetoothApp2State();
}

class _BluetoothApp2State extends State<BluetoothApp2> {
