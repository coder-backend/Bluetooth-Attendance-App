...
class BluetoothApp5 extends StatefulWidget {
  static const routebluetooth5 = '/bluetooth5-page';

  @override
  _BluetoothApp5State createState() => _BluetoothApp5State();
}

class _BluetoothApp5State extends State<BluetoothApp5> {
