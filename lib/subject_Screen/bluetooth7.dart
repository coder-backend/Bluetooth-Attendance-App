...
class BluetoothApp7 extends StatefulWidget {
  static const routebluetooth7 = '/bluetooth7-page';

  @override
  _BluetoothApp7State createState() => _BluetoothApp7State();
}

class _BluetoothApp7State extends State<BluetoothApp7> {
