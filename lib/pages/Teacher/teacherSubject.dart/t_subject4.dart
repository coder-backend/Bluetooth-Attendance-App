import 'package:bluetooth_app/subject_Screen/bluetooth4.dart';
import 'package:flutter/material.dart';
import '../Teacher_bluetooth/t_bluetooth4.dart';

class TSubjectFour extends StatelessWidget {
  static const troutesubject4 = '/tsubject-Four';
          ...
          FlatButton.icon(
            onPressed: () {
              Navigator.of(context)
                  .pushNamed(TBluetoothApp4.troutebluetooth4, arguments: {
