import '../Teacher_bluetooth/t_bluetooth7.dart';
import 'package:flutter/material.dart';

class TSubjectSeven extends StatelessWidget {
  static const troutesubject7 = '/tsubject-Seven';
          ...
          FlatButton.icon(
            onPressed: () {
              Navigator.of(context)
                  .pushNamed(TBluetoothApp7.troutebluetooth7, arguments: {
