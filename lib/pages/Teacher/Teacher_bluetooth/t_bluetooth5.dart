...
class TBluetoothApp5 extends StatefulWidget {
  static const troutebluetooth5 = '/tbluetooth5-page';

  @override
  _TBluetoothApp5State createState() => _TBluetoothApp5State();
}

class _TBluetoothApp5State extends State<TBluetoothApp5> {
                                        ...
                                        if (_formKey.currentState.validate()) {
                                          await TeacherdatabaseService(uid: uid)
                                              .updateUserData(
                                                 ...
                                                 _currentAttendance ?? userData.attendance5,
