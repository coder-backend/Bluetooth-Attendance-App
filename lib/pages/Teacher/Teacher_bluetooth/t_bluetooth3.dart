...
class TBluetoothApp3 extends StatefulWidget {
  static const troutebluetooth3 = '/tbluetooth3-page';

  @override
  _TBluetoothApp3State createState() => _TBluetoothApp3State();
}

class _TBluetoothApp3State extends State<TBluetoothApp3> {
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      home: Scaffold(
        ...
        body: StreamBuilder<TeacherData>(
                              ...
                              child: Column(
                                ...
                                children: <Widget>[
                                  ...
                                  RaisedButton(
                                      child: Text('Submit'),
                                      onPressed: () async {
                                        if(_device.name=='Ashim')
                                        {
                                        _currentAttendance = attendance + 1;
                                        }

                                        if (_formKey.currentState.validate()) {
                                          await TeacherdatabaseService(uid: uid)
                                              .updateUserData(
                                                 
                                                  userData.attendance1,
                                                  userData.attendance2,
                                                  _currentAttendance ?? userData.attendance3,
