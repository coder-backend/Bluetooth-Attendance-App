...
class TBluetoothApp7 extends StatefulWidget {
  static const troutebluetooth7 = '/tbluetooth7-page';

  @override
  _TBluetoothApp7State createState() => _TBluetoothApp7State();
}

class _TBluetoothApp7State extends State<TBluetoothApp7> {
                                        ...
                                        if (_formKey.currentState.validate()) {
                                          await TeacherdatabaseService(uid: uid)
                                              .updateUserData(
                                                ...
                                                _currentAttendance ??  userData.attendance7,
                                                  userData.name,
