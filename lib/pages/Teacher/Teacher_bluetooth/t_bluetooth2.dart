...
class TBluetoothApp2 extends StatefulWidget {
  static const troutebluetooth2 = '/tbluetooth2-page';

  @override
  _TBluetoothApp2State createState() => _TBluetoothApp2State();
}

class _TBluetoothApp2State extends State<TBluetoothApp2> {
                                        ...
                                        if (_formKey.currentState.validate()) {
                                          await TeacherdatabaseService(uid: uid)
                                              .updateUserData(
                                                 ...
                                                 _currentAttendance ?? userData.attendance2,
