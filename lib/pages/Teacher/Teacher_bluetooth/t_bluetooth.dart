...
class TBluetoothApp extends StatefulWidget {
  static const troutebluetooth = '/tbluetooth-page';

  @override
  _TBluetoothAppState createState() => _TBluetoothAppState();
}

class _TBluetoothAppState extends State<TBluetoothApp> {
