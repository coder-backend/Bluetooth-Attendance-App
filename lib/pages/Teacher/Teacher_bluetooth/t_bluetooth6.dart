...
class TBluetoothApp6 extends StatefulWidget {
  static const troutebluetooth6 = '/tbluetooth6-page';

  @override
  _TBluetoothApp6State createState() => _TBluetoothApp6State();
}

class _TBluetoothApp6State extends State<TBluetoothApp6> {
                                        ...
                                        if (_formKey.currentState.validate()) {
                                          await TeacherdatabaseService(uid: uid)
                                              .updateUserData(
                                                  ...
                                                  _currentAttendance ?? userData.attendance6,
