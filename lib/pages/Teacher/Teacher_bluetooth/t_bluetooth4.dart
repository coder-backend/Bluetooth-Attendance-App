...
class TBluetoothApp4 extends StatefulWidget {
  static const troutebluetooth4 = '/tbluetooth4-page';

  @override
  _TBluetoothApp4State createState() => _TBluetoothApp4State();
}

class _TBluetoothApp4State extends State<TBluetoothApp4> {
                                        ...
                                        if (_formKey.currentState.validate()) {
                                          await TeacherdatabaseService(uid: uid)
                                              .updateUserData(
                                                ...
                                                _currentAttendance ??  userData.attendance4,
